...
horovodrun -np $RUNAI_MPI_NUM_WORKERS -hostfile /etc/mpi/hostfile  python train.py --exp_dir ./experiments/exp0 --use_workers $USE_WORKERS --num_workers $NUM_WORKERS --batch_size $BATCH_SIZE